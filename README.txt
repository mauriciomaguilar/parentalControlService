...
2 - Open 'com.parentalControl.controller.ApplicationController' class and Run
3 - Open a WebBrowser and type: http://localhost:8080/parentalControlService?controlLevel='X'&movieId='Y'
